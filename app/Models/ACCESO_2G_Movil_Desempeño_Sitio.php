...
class ACCESO_2G_Movil_Desempeño_Sitio extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'PSO_0DATA_01_29';
    public $primaryKey = 'site_name';
    // public $timestamps = false;
    // protected $guarded = ['cellname'];
    protected $fillable = ['site_name','controladora','distrito','provincia','sub_region','region'];
