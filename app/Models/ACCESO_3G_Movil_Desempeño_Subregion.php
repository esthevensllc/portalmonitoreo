...
class ACCESO_3G_Movil_Desempeño_Subregion extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'PSO_0DATA_02_373';
    public $primaryKey = 'sub_region';
    // public $timestamps = false;
    // protected $guarded = ['cellname'];
    protected $fillable = ['sub_region','region'];
