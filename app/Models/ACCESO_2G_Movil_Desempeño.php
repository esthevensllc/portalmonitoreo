...
class ACCESO_2G_Movil_Desempeño extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'PSO_0DATA_01_369';
    public $primaryKey = 'cellname';
    // public $timestamps = false;
    // protected $guarded = ['cellname'];
    protected $fillable = ['cellname','controladora','site_name','distrito','provincia','sub_region','region'];
