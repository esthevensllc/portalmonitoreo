...
class ACCESO_3G_Movil_Desempeño extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'PSO_0DATA_02_369';
    public $primaryKey = 'cellname';
    // public $timestamps = false;
    // protected $guarded = ['cellname'];
    protected $fillable = ['cellname','sector_name','site_name','distrito','provincia','sub_region','region'];
    ...
    */
    ...
    public function getCeldas(){
        $sql = "BEGIN PSO_OSSPORTAL.SP_GET_MENUDATAFILBYSECTID(7191, :resultado); END;";
