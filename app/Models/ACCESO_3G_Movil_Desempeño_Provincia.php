...
class ACCESO_3G_Movil_Desempeño_Provincia extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'PSO_0DATA_02_371';
    public $primaryKey = 'provincia';
    // public $timestamps = false;
    // protected $guarded = ['cellname'];
    protected $fillable = ['provincia','sub_region','region'];
