...
class ACCESO_3G_Movil_Desempeño_Distrito extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'PSO_0DATA_02_370';
    public $primaryKey = 'distrito';
    // public $timestamps = false;
    // protected $guarded = ['cellname'];
    protected $fillable = ['distrito','provincia','sub_region','region'];
