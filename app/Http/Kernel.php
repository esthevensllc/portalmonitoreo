...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
	  ...
	  \App\Http\Middleware\ErrorHandlerException::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        'error.handler' => \App\Http\Middleware\ErrorHandlerException::class,
        ...
        'check.permission_graph' => \AMovil\Auth\Shared\Infrastructure\Laravel\Middleware\CheckPermissionGraphMiddleware::class,
    ];
