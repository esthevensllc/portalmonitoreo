...
use App\Http\Requests\ACCESO_5G_Movil_DesempeñoRequest;
 ...
 */
class ACCESO_5G_Movil_DesempeñoCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        if(\Request::has('filterSect')){
            switch($_GET['filterSect']){
                case '7400':
                    CRUD::setModel(\App\Models\ACCESO_5G_Movil_Desempeño::class);
                    break;
                case '7402':
                    CRUD::setModel(\App\Models\ACCESO_5G_Movil_Desempeño_Sector::class);
                    break;
                case '7401':
                    CRUD::setModel(\App\Models\ACCESO_5G_Movil_Desempeño_Sitio::class);
                    break;
                case '7399':
                    CRUD::setModel(\App\Models\ACCESO_5G_Movil_Desempeño_Distrito::class);
                    break;
                case '7398':
                    CRUD::setModel(\App\Models\ACCESO_5G_Movil_Desempeño_Provincia::class);
                    break;
                case '7396':
                    CRUD::setModel(\App\Models\ACCESO_5G_Movil_Desempeño_Subregion::class);
                    break;
                case '7397':
                    CRUD::setModel(\App\Models\ACCESO_5G_Movil_Desempeño_Region::class);
                    break;
            }
        }else{
            CRUD::setModel(\App\Models\ACCESO_5G_Movil_Desempeño::class);
        }
        CRUD::setRoute(config('backpack.base.route_prefix') . '/acceso_5g_movil_desempeño/{tracingID}/{menuID}');
        CRUD::setEntityNameStrings('acceso_5g_movil_desempeño', 'ACCESO | 5G Movil | Desempeño');
        $this->loadFilters();
    }
    ...
    protected function setupListOperation()
    {
        ...
        \Backpack\CRUD\app\Library\Widget::add([
            ...
            'options' => $secids,
            'values' => $sectnames,
            'selected' => \Request::has('filterSect')?$_GET['filterSect']:7400
        ])->to('before_content');
    ...
    {
        CRUD::setValidation(ACCESO_5G_Movil_DesempeñoRequest::class);
