...
use App\Http\Requests\REPORTE_DEPARTAMENTO_MENSUAL_CRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class REPORTE_DEPARTAMENTO_MENSUAL_CCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class REPORTE_DEPARTAMENTO_MENSUAL_CCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\REPORTE_DEPARTAMENTO_MENSUAL_C::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/reporte_departamento_mensual_c');
        CRUD::setEntityNameStrings('reporte_departamento_mensual_c', 'RP Departamento Mensual Consolidado 2G 3G');
        $this->loadFilters();
    }
    ...
    {
        CRUD::setValidation(REPORTE_DEPARTAMENTO_MENSUAL_CRequest::class);
