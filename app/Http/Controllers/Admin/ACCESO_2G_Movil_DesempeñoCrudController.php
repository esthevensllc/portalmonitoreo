...
use App\Http\Requests\ACCESO_2G_Movil_DesempeñoRequest;
 ...
 */
class ACCESO_2G_Movil_DesempeñoCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        if(\Request::has('filterSect')){
            switch($_GET['filterSect']){
                case '247':
                    CRUD::setModel(\App\Models\ACCESO_2G_Movil_Desempeño::class);
                    break;
                case '9356':
                    CRUD::setModel(\App\Models\ACCESO_2G_Movil_Desempeño_Sector::class);
                    break;
                case '249':
                    CRUD::setModel(\App\Models\ACCESO_2G_Movil_Desempeño_Sitio::class);
                    break;
                case '248':
                    CRUD::setModel(\App\Models\ACCESO_2G_Movil_Desempeño_Distrito::class);
                    break;
                case '9350':
                    CRUD::setModel(\App\Models\ACCESO_2G_Movil_Desempeño_Provincia::class);
                    break;
                case '9352':
                    CRUD::setModel(\App\Models\ACCESO_2G_Movil_Desempeño_Subregion::class);
                    break;
                case '9354':
                    CRUD::setModel(\App\Models\ACCESO_2G_Movil_Desempeño_Region::class);
                    break;
            }
        }else{
            CRUD::setModel(\App\Models\ACCESO_2G_Movil_Desempeño::class);
        }
        CRUD::setRoute(config('backpack.base.route_prefix') . '/acceso_2g_movil_desempeño/{tracingID}/{menuID}');
        CRUD::setEntityNameStrings('acceso_2g_movil_desempeño', 'ACCESO | 2G Movil | Desempeño');
        $this->loadFilters();
    }
    ...
    public function loadFilters(){
        ...
        $this->loadCriteriaFilter("CONTROLADORA", "CONTROLADORA");
    ...
    protected function setupListOperation()
    {
        ...
        \Backpack\CRUD\app\Library\Widget::add([
            ...
            'options' => $secids,
            'values' => $sectnames,
            'selected' => \Request::has('filterSect')?$_GET['filterSect']:247
        ])->to('before_content');
    ...
    {
        CRUD::setValidation(ACCESO_2G_Movil_DesempeñoRequest::class);
