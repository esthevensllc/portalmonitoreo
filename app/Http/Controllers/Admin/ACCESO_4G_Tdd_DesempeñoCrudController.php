...
use App\Http\Requests\ACCESO_4G_Tdd_DesempeñoRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use Illuminate\Http\Request;

/**
 * Class ACCESO_4G_Tdd_DesempeñoCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ACCESO_4G_Tdd_DesempeñoCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        if(\Request::has('filterSect')){
            switch($_GET['filterSect']){
                case '1199':
                    CRUD::setModel(\App\Models\ACCESO_4G_Tdd_Desempeño::class);
                    break;
                case '1547':
                    CRUD::setModel(\App\Models\ACCESO_4G_Tdd_Desempeño_Sector::class);
                    break;
                case '1200':
                    CRUD::setModel(\App\Models\ACCESO_4G_Tdd_Desempeño_Sitio::class);
                    break;
                case '1198':
                    CRUD::setModel(\App\Models\ACCESO_4G_Tdd_Desempeño_Distrito::class);
                    break;
                case '1197':
                    CRUD::setModel(\App\Models\ACCESO_4G_Tdd_Desempeño_Provincia::class);
                    break;
                case '1195':
                    CRUD::setModel(\App\Models\ACCESO_4G_Tdd_Desempeño_Subregion::class);
                    break;
                case '1196':
                    CRUD::setModel(\App\Models\ACCESO_4G_Tdd_Desempeño_Region::class);
                    break;
            }
        }else{
            CRUD::setModel(\App\Models\ACCESO_4G_Tdd_Desempeño::class);
        }
        CRUD::setRoute(config('backpack.base.route_prefix') . '/acceso_4g_tdd_desempeño/{tracingID}/{menuID}');
        CRUD::setEntityNameStrings('acceso_4g_tdd_desempeño', 'ACCESO | 4G Tdd | Desempeño');
        $this->loadFilters();
    }
    ...
    protected function setupListOperation()
    {
        ...
        \Backpack\CRUD\app\Library\Widget::add([
            ...
            'options' => $secids,
            'values' => $sectnames,
            'selected' => \Request::has('filterSect')?$_GET['filterSect']:1199
        ])->to('before_content');
    ...
    {
        CRUD::setValidation(ACCESO_4G_Tdd_DesempeñoRequest::class);
