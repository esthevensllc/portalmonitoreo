...
use App\Http\Requests\RESUMEN_CVM_OPERADOR_RCRRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use App\Entities\CriteriaOperatorEntity;

/**
 * Class RESUMEN-CVM-OPERADOR-RCRCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class RESUMEN_CVM_OPERADOR_RCRCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\RESUMEN_CVM_OPERADOR_RCR::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/resumen-cvm-operador-rcr');
        CRUD::setEntityNameStrings('resumen-cvm-operador-rcr', 'Resumen Recurrente');
        $this->loadFilters();
    }
    ...
    private function loadFilters(){
        ...
        $this->loadCriteriaFilter('NUM_MUESTRAS', 'NUM_MUESTRAS', CriteriaOperatorEntity::numberOperators());
        $this->loadCriteriaFilter('MSTRAS_HACE_7DIAS', 'MSTRAS HACE 7DIAS', CriteriaOperatorEntity::numberOperators());
    ...
    {
        CRUD::setValidation(RESUMEN_CVM_OPERADOR_RCRRequest::class);
