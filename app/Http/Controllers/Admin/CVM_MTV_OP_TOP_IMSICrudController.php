...
use App\Http\Requests\CVM_MTV_OP_TOP_IMSIRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use App\Entities\CriteriaOperatorEntity;

/**
 * Class CVM_MTV_OP_TOP_IMSICrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class CVM_MTV_OP_TOP_IMSICrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\CVM_MTV_OP_TOP_IMSI::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/cvm_mtv_op_top_imsi');
        CRUD::setEntityNameStrings('cvm_mtv_op_top_imsi', 'Top 5 IMSI Por Ubigeo');
	$this->loadFilters();
    }
    ...
    private function loadFilters(){
        ...
        $this->loadCriteriaFilter('TOP5_IMSI', 'TOP5_IMSI', CriteriaOperatorEntity::numberOperators());
    }
    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->orderBy('top5_imsi','asc');
    ...
    {
        CRUD::setValidation(CVM_MTV_OP_TOP_IMSIRequest::class);
