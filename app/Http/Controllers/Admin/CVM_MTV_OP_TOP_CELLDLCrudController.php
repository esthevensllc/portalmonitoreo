...
use App\Http\Requests\CVM_MTV_OP_TOP_CELLDLRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use App\Entities\CriteriaOperatorEntity;

/**
 * Class CVM_MTV_OP_TOP_CELLDLCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class CVM_MTV_OP_TOP_CELLDLCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\CVM_MTV_OP_TOP_CELLDL::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/cvm_mtv_op_top_celldl');
        CRUD::setEntityNameStrings('cvm_mtv_op_top_celldl', 'Top 5 CELDA_DL Por Ubigeo');
        $this->loadFilters();
    }
    ...
    private function loadFilters(){
        ...
        $this->loadCriteriaFilter('AVG_TH_DL_KBPS', 'AVG TH DL KBPS', CriteriaOperatorEntity::numberOperators());
    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->orderBy('top5_celldl','asc');
    ...
    {
        CRUD::setValidation(CVM_MTV_OP_TOP_CELLDLRequest::class);
