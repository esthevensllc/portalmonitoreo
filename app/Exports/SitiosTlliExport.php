...
class SitiosTlliExport implements FromQuery, WithHeadings, WithStyles,WithColumnWidths, ShouldAutoSize, WithColumnFormatting, WithMapping
{
    use Exportable;
    ...
    {
        return SITIOS_OBSERVADOS_TLLI::select('id','site_name','bcf_address','departamento','tipo_obs_fitel','tecnologia','grupo_motivo','detalle_motivo','accion_solucion','solution_at')->where('estado',1);
    }
