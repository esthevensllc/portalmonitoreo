		...
		<div class="modal-dialog modal-md">
		  <div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Actualizar CM-CVM</h5>
			...
			<div class="modal-body">
				<form  enctype="multipart/form-data" id="update_form">
					...
					<div class="row">
						...
						<div class="col-4 form-group">
							<label for="">DL 3G</label>
							<input type="text" class="form-control form-control-sm" name="dl_3g" id="u_dl_3g">
							<span class="invalid-feedback d-block mb-0" id="u_e_dl_3g"></span>
						</div>
						<div class="col-4 form-group">
							<label for="">DL 4G</label>
							<input type="text" class="form-control form-control-sm" name="dl_4g" id="u_dl_4g">
							<span class="invalid-feedback d-block mb-0" id="u_e_dl_4g"></span>
						</div>
						<div class="col-4 form-group">
							<label for="">UL 3G</label>
							<input type="text" class="form-control form-control-sm" name="ul_3g" id="u_ul_3g">
							<span class="invalid-feedback d-block mb-0" id="u_e_ul_3g"></span>
						</div>
						<div class="col-4 form-group">
							<label for="">UL 4G</label>
							<input type="text" class="form-control form-control-sm" name="ul_4g" id="u_ul_4g">
							<span class="invalid-feedback d-block mb-0" id="u_e_ul_4g"></span>
						</div>
						<div class="col-12 form-group">
							<label for="">CM enviado</label>
                            <textarea class="form-control form-control-sm" name="cm_enviado" id="u_cm_enviado" rows="3"></textarea>
							<span class="invalid-feedback d-block mb-0" id="u_e_cm_enviado"></span>
						</div>
						<div class="col-4 form-group">
