@if ($crud->hasAccess('update'))
    <div class="dt-buttons btn-group d-xs-block d-sm-inline-block d-md-inline-block d-lg-inline-block" style="vertical-align: top;">
        <div class="btn-group" style="margin-left:2px">
            <button id="btnExportPoligons" class="btn btn-secondary buttons-collection buttons-colvis btn-sm" type="button" onclick="window.location.href='/portalregulatorio{{$crud->route}}_template/export'">Plantilla</button>
        </div>
