@if ($crud->exportButtons())
  <script src="{{asset('libs/datatables-buttons/1.5.6/js/dataTables.buttons.min.js')}}" type="text/javascript"></script>
  <script src="{{asset('libs/datatables-buttons/1.5.6/js/buttons.bootstrap4.min.js')}}" type="text/javascript"></script>
  <script src="{{asset('libs/jszip/2.5.0/jszip.min.js')}}" type="text/javascript"></script>
  <script src="{{asset('libs/pdfmake/0.1.18/pdfmake.min.js')}}" type="text/javascript"></script>
  <script src="{{asset('libs/pdfmake/0.1.18/vfs_fonts.js')}}" type="text/javascript"></script>
  <script src="{{asset('libs/datatables-buttons/1.5.6/js/buttons.html5.min.js')}}" type="text/javascript"></script>
  <script src="{{asset('libs/datatables-buttons/1.5.6/js/buttons.print.min.js')}}" type="text/javascript"></script>
  <script src="{{asset('libs/datatables-buttons/1.5.6/js/buttons.colVis.min.js')}}" type="text/javascript"></script>
